...
## 1. 代理模式  [<https://www.runoob.com/design-pattern/proxy-pattern.html>]
...
![代理模式类图](动态代理详解.assets/167cff3ba753f7f8)
...
![代理模式的 UML 图](动态代理详解.assets/proxy_pattern_uml_diagram.jpg)
...
public class UserServiceProxy implements UserService {
    private final UserService target; // 被代理的对象
...
![JDK 动态代理生成的代理类](动态代理详解.assets/167cff3ba6f537ab)
...
![JDK动态代理执行方法调用过程](动态代理详解.assets/167cff3ba6d23d8b)
...
>    《Java核心技术》卷1
>    《深入理解Java虚拟机》7.3
>    java docs: [docs.oracle.com/javase/8/do…](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Proxy.html)
